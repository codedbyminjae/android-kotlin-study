...
import com.example.umc.databinding.FragmentFloAlbumBinding

class AlbumFragment : Fragment() {

    private lateinit var binding: FragmentFloAlbumBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentFloAlbumBinding.inflate(inflater, container, false)

        // 뒤로가기 버튼 → HomeFragment로 전환
