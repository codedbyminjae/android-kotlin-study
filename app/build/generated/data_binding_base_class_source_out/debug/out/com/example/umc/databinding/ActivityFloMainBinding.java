...
public final class ActivityFloMainBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityFloMainBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityFloMainBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFloMainBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_flo_main, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFloMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFloMainBinding((ConstraintLayout) rootView, mainBnv, mainFrm,
