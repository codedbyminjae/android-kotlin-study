...
public final class FragmentMypageBinding implements ViewBinding {
  ...
  private FragmentMypageBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvMypage) {
    this.rootView = rootView;
    this.tvMypage = tvMypage;
  }
  ...
  public static FragmentMypageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.tv_mypage;
      TextView tvMypage = ViewBindings.findChildViewById(rootView, id);
      if (tvMypage == null) {
        break missingId;
      }

      return new FragmentMypageBinding((ConstraintLayout) rootView, tvMypage);
    }
