...
public final class ActivityFloSongBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityFloSongBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView songAlbumIv,
  ...
  @NonNull
  public static ActivityFloSongBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFloSongBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_flo_song, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFloSongBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFloSongBinding((ConstraintLayout) rootView, songAlbumIv, songDownIb,
