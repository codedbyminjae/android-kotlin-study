...
public final class FragmentDiaryBinding implements ViewBinding {
  ...
  private FragmentDiaryBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvDiary) {
  ...
  public static FragmentDiaryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDiaryBinding((ConstraintLayout) rootView, tvDiary);
    }
